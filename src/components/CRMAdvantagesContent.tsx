      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 font-display">11 Key Advantages of <span className="text-brand">CRM Platforms</span></h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
            {advantages.map((adv, i) => (
              <div key={i} className="p-8 bg-slate-50 border border-slate-100 rounded-[2rem] hover:bg-white hover:shadow-xl transition-all h-full italic">
                <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-brand mb-6">
                  <adv.icon className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-2 italic">{adv.title}</h3>
                <p className="text-slate-500 italic leading-relaxed">{adv.desc}</p>
              </div>
            ))}
          </div>

          <div className="bg-slate-900 p-12 rounded-[3.5rem] italic text-white flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              <h2 className="text-3xl font-bold mb-6 italic">Why CRM Matters</h2>
            ...
            <div className="flex-shrink-0">
               <button className="px-10 py-5 bg-brand text-white font-bold rounded-2xl shadow-xl shadow-brand/20">Explore All Benefits</button>
            </div>
          </div>
        </motion.div>
      </div>
